...
const translations = {
  ...
  ti: { churchName: 'ካቴድራል ቅድስት ማርያም', churchLocation: 'ጅማ, ኢትዮጵያ', stayConnected: 'ሓበሬታ ኹኑ', newsletterPrompt: 'ሓድሽ ዜናታትን ፍጻመታትን ኣብ ኢመይል ሳጹንኩም ተቐበሉ', emailPlaceholder: 'ኢሜይልኩም ኣእትዉ', motto: 'ንሕና ግና ንጸሎትን ንኣገልግሎት ቃሉን ንተጋገር። — ግብረ ሐዋርያት 6፡4', explore: 'ኣስስ', support: 'ድጋፍ', getInTouch: 'ተራኸቡና', copyright: 'መሰሉ ብሕጊ ዝተሓለወ እዩ', home: 'መበገሲ', aboutUs: 'ብዛዕባና', events: 'ፍጻመታት', gallery: 'መአከቢ ስእሊ', mediaAndTech: 'ሚድያን ቴክን', ourClasses: 'ክፍልታትና', newsUpdates: 'ዜናን ሓበሬታን', contactUs: 'ተራኸቡና' },
