...
const translations = {
  ...
  am: { churchName: 'የቅድስት ማርያም ካቴድራል', churchLocation: 'ጅማ, ኢትዮጵያ', stayConnected: 'ሙሉ መረጃ ያግኙ', newsletterPrompt: 'የቅርብ ጊዜ ዜናዎችን እና ክስተቶችን በኢሜይል መልእክት ሳጥንዎ ያግኙ።', emailPlaceholder: 'ኢሜልዎን ያስገቡ', motto: 'እኛ ግን የተሰቀለውን ክርስቶስን እንሰብካለን፤ ይህም ለአይሁድ ማሰናከያ ለአሕዛብም ሞኝነት ነው፥', explore: 'ያስሱ', support: 'ድጋፍ', getInTouch: 'ያግኙን', copyright: 'ሁሉም መብቶች የተጠበቁ ናቸው', home: 'መነሻ', aboutUs: 'ስለ እኛ', events: 'ክስተቶች', gallery: 'ጋለሪ', ourClasses: 'ትምህርቶቻችን', newsUpdates: 'ዜና እና ዝመናዎች', contactUs: 'ያግኙን' },
  om: { churchName: 'Katidiraalii Qulqulleettii Maariyaam', churchLocation: 'Jimmaa, Itoophiyaa', stayConnected: 'Odeeffannoo Qabaadhaa', newsletterPrompt: 'Oduu fi taateewwan haaraa sanduuqa ergaa keessanitti argadhaa.', emailPlaceholder: 'Imeelii keessan galchaa', motto: 'Nuti garuu Kiristoos isa fannifame lallabna.', explore: 'Sakatta\'i', support: 'Deeggarsa', getInTouch: 'Nu Qunnamaa', copyright: 'Mirgi Hundi Seeraan Eegamaadha', home: 'Fuula Jalqabaa', aboutUs: 'Waa\'ee Keenya', events: 'Taateewwan', gallery: 'Kuusaa Suuraa', ourClasses: 'Barnoota Keenya', newsUpdates: 'Oduu fi Fooyya\'iinsa', contactUs: 'Nu Qunnamaa' },
  ti: { churchName: 'ካቴድራል ቅድስት ማርያም', churchLocation: 'ጅማ, ኢትዮጵያ', stayConnected: 'ሓበሬታ ኹኑ', newsletterPrompt: 'ሓድሽ ዜናታትን ፍጻመታትን ኣብ ኢመይል ሳጹንኩም ተቐበሉ', emailPlaceholder: 'ኢሜይልኩም ኣእትዉ', motto: 'ንሕና ግና ነቲ እተሰቕለ ክርስቶስ ንሰብኽ።', explore: 'ኣስስ', support: 'ድጋፍ', getInTouch: 'ተራኸቡና', copyright: 'መሰሉ ብሕጊ ዝተሓለወ እዩ', home: 'መበገሲ', aboutUs: 'ብዛዕባና', events: 'ፍጻመታት', gallery: 'መአከቢ ስእሊ', ourClasses: 'ክፍልታትና', newsUpdates: 'ዜናን ሓበሬታን', contactUs: 'ተራኸቡና' },
  ge: { churchName: 'ቤተ ፡ ክርስቲያን ፡ ቅድስት ፡ ማርያም', churchLocation: 'ጅማ ፡ ኢትዮጵያ', stayConnected: 'ተአምኁ ፡ ወትረ', newsletterPrompt: 'ዜና ፡ ሐዲስ ፡ ወግብረ ፡ በኢሜይል ፡ በጽሐክሙ።', emailPlaceholder: 'አግባእ ፡ ኢሜይለከ', motto: 'ወንሕነሰ ፡ ንሰብክ ፡ ክርስቶስ ፡ ዘተሰቅለ።', explore: 'አስስ', support: 'ረድኤት', getInTouch: 'ተራከቡነ', copyright: 'ኵሉ ፡ መብት ፡ ኅልው ፡ ውእቱ።', home: 'አርእስት', aboutUs: 'ስለ ፡ አነ', events: 'ምክንያታት', gallery: 'ማዕከለ ፡ ስእል', ourClasses: 'ክፍለ ፡ ትምህርትነ', newsUpdates: 'ዜና ፡ ወሐዲስ', contactUs: 'ተራከቡነ' },
  ...
  fr: { churchName: 'Cathédrale Sainte-Marie', churchLocation: 'Jimma, Éthiopie', stayConnected: 'Restez Informé', newsletterPrompt: 'Recevez les dernières nouvelles et événements dans votre boîte de réception.', emailPlaceholder: 'Entrez votre courriel', motto: 'Nous, nous prêchons Christ crucifié.', explore: 'Explorer', support: 'Soutien', getInTouch: 'Contactez-nous', copyright: 'Tous Droits Réservés', home: 'Accueil', aboutUs: 'À Propos de Nous', events: 'Événements', gallery: 'Galerie', ourClasses: 'Nos Cours', newsUpdates: 'Nouvelles et Mises à Jour', contactUs: 'Contactez-nous' },
  ar: { churchName: 'كاتدرائية القديسة مريم', churchLocation: 'جيما، إثيوبيا', stayConnected: 'ابق على اطلاع', newsletterPrompt: 'احصل على آخر الأخبار والفعاليات في بريدك الوارد.', emailPlaceholder: 'أدخل بريدك الإلكتروني', motto: 'ولكننا نحن نكرز بالمسيح مصلوبا.', explore: 'استكشف', support: 'الدعم', getInTouch: 'تواصل معنا', copyright: 'كل الحقوق محفوظة', home: 'الرئيسية', aboutUs: 'من نحن', events: 'الفعاليات', gallery: 'المعرض', ourClasses: 'فصولنا', newsUpdates: 'الأخبار والتحديثات', contactUs: 'اتصل بنا' },
};
