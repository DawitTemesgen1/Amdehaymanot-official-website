...
const translations = {
  en: { churchName: 'Saint Mary Cathedral', churchLocation: 'Jimma, Ethiopia', stayConnected: 'Stay Informed', newsletterPrompt: 'Get the latest news and events delivered to your inbox.', emailPlaceholder: 'Enter your email', motto: 'But we will give ourselves continually to prayer, and to the ministry of the word. — Acts 6:4', explore: 'Explore', support: 'Support', getInTouch: 'Get In Touch', copyright: 'All Rights Reserved', home: 'Home', aboutUs: 'About Us', events: 'Events', gallery: 'Gallery', mediaAndTech: 'Media & Tech', ourClasses: 'Our Classes', newsUpdates: 'News & Updates', contactUs: 'Contact Us' },
  am: { churchName: 'የቅድስት ማርያም ካቴድራል', churchLocation: 'ጅማ, ኢትዮጵያ', stayConnected: 'ሙሉ መረጃ ያግኙ', newsletterPrompt: 'የቅርብ ጊዜ ዜናዎችን እና ክስተቶችን በኢሜይል መልእክት ሳጥንዎ ያግኙ።', emailPlaceholder: 'ኢሜልዎን ያስገቡ', motto: 'እኛ ግን ለጸሎትና ቃሉን ለማገልገል እንተጋለን። — ሐዋርያት 6፥4', explore: 'ያስሱ', support: 'ድጋፍ', getInTouch: 'ያግኙን', copyright: 'ሁሉም መብቶች የተጠበቁ ናቸው', home: 'መነሻ', aboutUs: 'ስለ እኛ', events: 'ክስተቶች', gallery: 'ጋለሪ', mediaAndTech: 'ሚዲያ እና ቴክ', ourClasses: 'ትምህርቶቻችን', newsUpdates: 'ዜና እና ዝመናዎች', contactUs: 'ያግኙን' },
  om: { churchName: 'Katidiraalii Qulqulleettii Maariyaam', churchLocation: 'Jimmaa, Itoophiyaa', stayConnected: 'Odeeffannoo Qabaadhaa', newsletterPrompt: 'Oduu fi taateewwan haaraa sanduuqa ergaa keessanitti argadhaa.', emailPlaceholder: 'Imeelii keessan galchaa', motto: 'Nuti garuu kadhaafi tajaajila jechaatti of kennaa. — Hojii Ergamtootaa 6:4', explore: 'Sakatta\'i', support: 'Deeggarsa', getInTouch: 'Nu Qunnamaa', copyright: 'Mirgi Hundi Seeraan Eegamaadha', home: 'Fuula Jalqabaa', aboutUs: 'Waa\'ee Keenya', events: 'Taateewwan', gallery: 'Kuusaa Suuraa', mediaAndTech: 'Miidiyaa & Teek', ourClasses: 'Barnoota Keenya', newsUpdates: 'Oduu fi Fooyya\'iinsa', contactUs: 'Nu Qunnamaa' },
  ti: { churchName: 'ካቴድራል ቅድስት ድንግል ማርያም', churchLocation: 'ጅማ, ኢትዮጵያ', stayConnected: 'ሓበሬታ ኹኑ', newsletterPrompt: 'ሓድሽ ዜናታትን ፍጻመታትን ኣብ ኢመይል ሳጹንኩም ተቐበሉ', emailPlaceholder: 'ኢሜይልኩም ኣእትዉ', motto: 'ንሕና ግና ንጸሎትን ንኣገልግሎት ቃሉን ንተጋገር። — ግብረ ሐዋርያት 6፡4', explore: 'ኣስስ', support: 'ድጋፍ', getInTouch: 'ተራኸቡና', copyright: 'መሰሉ ብሕጊ ዝተሓለወ እዩ', home: 'መበገሲ', aboutUs: 'ብዛዕባና', events: 'ፍጻመታት', gallery: 'መአከቢ ስእሊ', mediaAndTech: 'ሚድያን ቴክን', ourClasses: 'ክፍልታትና', newsUpdates: 'ዜናን ሓበሬታን', contactUs: 'ተራኸቡና' },
  ge: { churchName: 'ቤተ ፡ ክርስቲያን ፡ ቅድስት ፡ ማርያም', churchLocation: 'ጅማ ፡ ኢትዮጵያ', stayConnected: 'ተአምኁ ፡ ወትረ', newsletterPrompt: 'ዜና ፡ ሐዲስ ፡ ወግብረ ፡ በኢሜይል ፡ በጽሐክሙ።', emailPlaceholder: 'አግባእ ፡ ኢሜይለከ', motto: 'ወንሕነሰ ለጸሎት ወለአገልግሎተ ቃል ንትጋ። — ግብረ ሐዋርያት ፮፡፬', explore: 'አስስ', support: 'ረድኤት', getInTouch: 'ተራከቡነ', copyright: 'ኵሉ ፡ መብት ፡ ኅልው ፡ ውእቱ።', home: 'አርእስት', aboutUs: 'ስለ ፡ አነ', events: 'ምክንያታት', gallery: 'ማዕከለ ፡ ስእል', mediaAndTech: 'ሚዲያ ወቴክ', ourClasses: 'ክፍለ ፡ ትምህርትነ', newsUpdates: 'ዜና ፡ ወሐዲስ', contactUs: 'ተራከቡነ' },
  es: { churchName: 'Catedral de Santa Virgen María', churchLocation: 'Jimma, Etiopía', stayConnected: 'Manténgase Informado', newsletterPrompt: 'Reciba las últimas noticias y eventos en su bandeja de entrada.', emailPlaceholder: 'Ingrese su correo electrónico', motto: 'Pero nosotros nos dedicaremos continuamente a la oración y al ministerio de la palabra. — Hechos 6:4', explore: 'Explorar', support: 'Apoyo', getInTouch: 'Ponerse en Contacto', copyright: 'Todos los Derechos Reservados', home: 'Inicio', aboutUs: 'Sobre Nosotros', events: 'Eventos', gallery: 'Galería', mediaAndTech: 'Media y Tech', ourClasses: 'Nuestras Clases', newsUpdates: 'Noticias y Actualizaciones', contactUs: 'Contáctenos' },
  fr: { churchName: 'Cathédrale Sainte Vierge Marie', churchLocation: 'Jimma, Éthiopie', stayConnected: 'Restez Informé', newsletterPrompt: 'Recevez les dernières nouvelles et événements dans votre boîte de réception.', emailPlaceholder: 'Entrez votre courriel', motto: 'Et nous nous appliquerons à la prière et au ministère de la parole. — Actes 6:4', explore: 'Explorer', support: 'Soutien', getInTouch: 'Contactez-nous', copyright: 'Tous Droits Réservés', home: 'Accueil', aboutUs: 'À Propos de Nous', events: 'Événements', gallery: 'Galerie', mediaAndTech: 'Média & Tech', ourClasses: 'Nos Cours', newsUpdates: 'Nouvelles et Mises à Jour', contactUs: 'Contactez-nous' },
  ar: { churchName: 'كاتدرائية القديسة مريم', churchLocation: 'جيما، إثيوبيا', stayConnected: 'ابق على اطلاع', newsletterPrompt: 'احصل على آخر الأخبار والفعاليات في بريدك الوارد.', emailPlaceholder: 'أدخل بريدك الإلكتروني', motto: 'وأما نحن فنواظب على الصلاة وخدمة الكلمة. — أعمال الرسل ٦:٤', explore: 'استكشف', support: 'الدعم', getInTouch: 'تواصل معنا', copyright: 'كل الحقوق محفوظة', home: 'الرئيسية', aboutUs: 'من نحن', events: 'الفعاليات', gallery: 'المعرض', mediaAndTech: 'إعلام وتقنية', ourClasses: 'فصولنا', newsUpdates: 'الأخبار والتحديثات', contactUs: 'اتصل بنا' },
};
