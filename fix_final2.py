...
fix_lang_block('src/pages/GalleryPage.js', 'ar', '"ctaButton": "ያግኙን"', '"ctaButton": "اتصل بنا"')
fix_lang_block('src/pages/GalleryPage.js', 'ar', '"ctaSubtitle": "የሰንበት ትምህርት ቤታችንን ይቀላቀሉ እና በእምነት፣ በአምልኮ እና በኅብረት ሕይወት ይሳተፉ።"', '"ctaSubtitle": "انضم إلى مدرسة الأحد الخاصة بنا وشارك في حياة الإيمان والعبادة والزمالة."')
